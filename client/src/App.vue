...
export default {
  ...
  async mounted() {
    const response = await axios.get('api/listItmes/')
    this.items = response.data
  },
  methods: {
    async addItem() {
      const response = await axios.post('api/listItmes/', {
    ...
    async removeItem(item, i) {
      await axios.delete('api/listItmes/' + item._id)
    ...
    async updateItem(item, i) {
      const response = await axios.put('api/listItmes/' + item._id, {
